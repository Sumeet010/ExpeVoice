...
export const BudgetsView: React.FC<BudgetsViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
                    ...
                    <button
                      onClick={() => setCategoryToDelete(b.category)}
      ...
      {/* Delete Category Threshold Confirmation Warning Popup Modal */}
      {categoryToDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-[#141418] border border-zinc-800 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden p-6 space-y-4">
            <div className="flex items-start gap-3.5">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-base font-bold text-white">Delete Category Threshold?</h3>
                <p className="text-xs text-zinc-400 mt-1 leading-relaxed">
                  Are you sure you want to remove the monthly threshold for <strong className="text-white">{categoryToDelete}</strong>? Your existing expenses in this category will remain unaffected.
                </p>
              </div>
            </div>
